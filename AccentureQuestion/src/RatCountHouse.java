...
public class RatCountHouse {
    public static void main(String[] args) {
        ...
        System.out.print("Enter the number of rat :");
        int r = sc.nextInt();
        System.out.print("Enter the number of food units : ");
        int unit = sc.nextInt();
        ...
        System.out.println("Minimum number of house required = "+ count(r,unit, arr, size));

    }
    public static int count(int r, int unit, int[] arr, int size){
        int sum = 0;
        int count = 0;
        for(int i=0; i< size; i++){
            sum += arr[i];
